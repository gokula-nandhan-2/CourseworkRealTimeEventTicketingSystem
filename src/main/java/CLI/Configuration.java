...
public class Configuration {
    ...
    public void saveFileToJson() {
        Gson gson = new Gson();
        try (FileWriter writeFile = new FileWriter("configurationCLI.json")){
    ...
    public void saveFileToTextFile() {
        try (FileWriter writeToTextFile = new FileWriter("configurationCLI.txt")) {
    ...
    public Configuration loadFileFromJson() {
        Gson gson = new Gson();
        try(FileReader readFile = new FileReader("configurationCLI.json")){
